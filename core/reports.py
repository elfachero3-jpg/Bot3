...
def solo_feedback_conversation(
    ...
    try:
        ...
        # Add transcription context (only on first message)
        if len(chat_history) == 0:
            conversation_parts.append(types.Part(text=f"""CLASSROOM AUDIO TRANSCRIPTION:
{transcription}

You have access to the full transcription above. The teacher is now ready to reflect on this lesson with your guidance. Begin the conversation with a warm, open-ended question that invites reflection."""))
